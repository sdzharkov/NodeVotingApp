...
makeRequest("pollData", pollWork);

var blue = [0,0,255];
var gray = [187,187,187];

function pollWork(resp) {
    //console.log(resp);
    var lol = JSON.parse(resp);
   console.log(lol);
    var theDiv = document.getElementById("rightSide");
    for (var i = 0; i < 3; i++) {
        var content = document.createElement('p');
        content.textContent = "Hillary:"+lol[i][0].responses[0].value+ " Bernie:" + lol[i][0].responses[1].value;
